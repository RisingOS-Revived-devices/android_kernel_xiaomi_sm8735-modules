...
static int aw_monitor_check_fw_v_0_1_2(struct aw_device *aw_dev, uint8_t *data,
				       uint32_t data_len)
{
	...
	if (data_len < sizeof(struct aw_monitor_hdr_v_0_1_2)) {
		aw_dev_err(aw_dev->dev,
			   "params size[%d] < struct aw_monitor_hdr size[%d]!",
			   data_len,
			   (int)sizeof(struct aw_monitor_hdr_v_0_1_2));
		return -ENOMEM;
	}
...
static void aw_monitor_parse_hdr_v_0_1_2(struct aw_device *aw_dev,
					 uint8_t *data)
{
	struct aw_monitor_hdr_v_0_1_2 *monitor_hdr =
		(struct aw_monitor_hdr_v_0_1_2 *)data;
	...
	monitor_cfg->temp_source =
		(monitor_hdr->enable_flag >> MONITOR_TEMPERATURE_SOURCE_BIT) &
		MONITOR_EN_MASK;
	monitor_cfg->vol_source =
		(monitor_hdr->enable_flag >> MONITOR_VOLTAGE_SOURCE_BIT) &
		MONITOR_EN_MASK;
	monitor_cfg->vol_mode =
		(monitor_hdr->enable_flag >> MONITOR_VOLTAGE_MODE_BIT) &
		MONITOR_EN_MASK;
...
static int aw_monitor_parse_temp_data_v_0_1_2(struct aw_device *aw_dev,
					      uint8_t *data)
{
	struct aw_monitor_hdr_v_0_1_2 *monitor_hdr =
		(struct aw_monitor_hdr_v_0_1_2 *)data;
...
static int aw_monitor_parse_vol_data_v_0_1_2(struct aw_device *aw_dev,
					     uint8_t *data)
{
	struct aw_monitor_hdr_v_0_1_2 *monitor_hdr =
		(struct aw_monitor_hdr_v_0_1_2 *)data;
