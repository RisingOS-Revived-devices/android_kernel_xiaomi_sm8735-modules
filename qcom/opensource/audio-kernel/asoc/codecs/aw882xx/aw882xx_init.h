...
#define AW_UVLS_UVLO_VALUE (AW_UVLS_UVLO << AW_UVLS_START_BIT)
...
#define AW_BSTS_FINISHED_VALUE (AW_BSTS_FINISHED << AW_BSTS_START_BIT)

/* SWS bit 8 (SYSST 0x01) */
#define AW_SWS_START_BIT (8)
#define AW_SWS_SWITCHING (1)
#define AW_SWS_SWITCHING_VALUE (AW_SWS_SWITCHING << AW_SWS_START_BIT)

/* NOCLKS bit 5 (SYSST 0x01) */
#define AW_NOCLKS_START_BIT (5)
#define AW_NOCLKS_NO_CLOCK (1)
#define AW_NOCLKS_NO_CLOCK_VALUE (AW_NOCLKS_NO_CLOCK << AW_NOCLKS_START_BIT)

/* CLKS bit 4 (SYSST 0x01) */
#define AW_CLKS_START_BIT (4)
#define AW_CLKS_STABLE (1)
#define AW_CLKS_STABLE_VALUE (AW_CLKS_STABLE << AW_CLKS_START_BIT)

/* OCDS bit 3 (SYSST 0x01) */
#define AW_OCDS_START_BIT (3)
#define AW_OCDS_OC (1)
#define AW_OCDS_OC_VALUE (AW_OCDS_OC << AW_OCDS_START_BIT)

/* OTHS bit 1 (SYSST 0x01) */
#define AW_OTHS_START_BIT (1)
#define AW_OTHS_OT (1)
#define AW_OTHS_OT_VALUE (AW_OTHS_OT << AW_OTHS_START_BIT)

/* PLLS bit 0 (SYSST 0x01) */
#define AW_PLLS_START_BIT (0)
#define AW_PLLS_LOCKED (1)
#define AW_PLLS_LOCKED_VALUE (AW_PLLS_LOCKED << AW_PLLS_START_BIT)

#define AW_SYSST_CHECK_MASK                                    \
	(~(AW_UVLS_UVLO_VALUE | AW_BSTOCS_OVER_CURRENT_VALUE | \
	   AW_BSTS_FINISHED_VALUE | AW_SWS_SWITCHING_VALUE |   \
	   AW_NOCLKS_NO_CLOCK_VALUE | AW_CLKS_STABLE_VALUE |   \
	   AW_OCDS_OC_VALUE | AW_OTHS_OT_VALUE | AW_PLLS_LOCKED_VALUE))

#define AW_SWS_SYSST_CHECK                                 \
	(AW_BSTS_FINISHED_VALUE | AW_SWS_SWITCHING_VALUE | \
	 AW_CLKS_STABLE_VALUE | AW_PLLS_LOCKED_VALUE)

#define AW_NO_SWS_SYSST_CHECK \
	(AW_BSTS_FINISHED_VALUE | AW_CLKS_STABLE_VALUE | AW_PLLS_LOCKED_VALUE)

#define AW_IIS_CHECK (AW_CLKS_STABLE_VALUE | AW_PLLS_LOCKED_VALUE)

/* UVLI bit 14 (SYSINT 0x02) */
#define AW_UVLI_START_BIT (14)
#define AW_UVLI_BITS_LEN (1)
#define AW_UVLI_MASK (~(((1 << AW_UVLI_BITS_LEN) - 1) << AW_UVLI_START_BIT))
...
#define AW_OCDI_MASK (~(((1 << AW_OCDI_BITS_LEN) - 1) << AW_OCDI_START_BIT))

/* OTHI bit 1 (SYSINT 0x02) */
#define AW_OTHI_START_BIT (1)
#define AW_OTHI_BITS_LEN (1)
#define AW_OTHI_MASK (~(((1 << AW_OTHI_BITS_LEN) - 1) << AW_OTHI_START_BIT))
...
#define AW_RCV_MODE_SPEAKER_VALUE (AW_RCV_MODE_SPEAKER << AW_RCV_MODE_START_BIT)
...
#define AW_PWDN_MASK (~(((1 << AW_PWDN_BITS_LEN) - 1) << AW_PWDN_START_BIT))

#define AW_PWDN_DISABLE (0)
#define AW_PWDN_DISABLE_VALUE (AW_PWDN_DISABLE << AW_PWDN_START_BIT)

#define AW_PWDN_ENABLE (1)
#define AW_PWDN_ENABLE_VALUE (AW_PWDN_ENABLE << AW_PWDN_START_BIT)

/* AMPPD bit 1 (SYSCTRL 0x04) */
#define AW_AMPPD_START_BIT (1)
#define AW_AMPPD_BITS_LEN (1)
#define AW_AMPPD_MASK (~(((1 << AW_AMPPD_BITS_LEN) - 1) << AW_AMPPD_START_BIT))

#define AW_AMPPD_ENABLE (0)
#define AW_AMPPD_WORK_VALUE (AW_AMPPD_ENABLE << AW_AMPPD_START_BIT)

#define AW_AMPPD_DISABLE (1)
#define AW_AMPPD_POWERDONE_VALUE (AW_AMPPD_DISABLE << AW_AMPPD_START_BIT)

/* HMUTE bit 8 (SYSCTRL 0x04) */
#define AW_HMUTE_START_BIT (8)
#define AW_HMUTE_BITS_LEN (1)
#define AW_HMUTE_MASK (~(((1 << AW_HMUTE_BITS_LEN) - 1) << AW_HMUTE_START_BIT))

#define AW_HMUTE_ENABLE (1)
#define AW_HMUTE_ENABLE_VALUE (AW_HMUTE_ENABLE << AW_HMUTE_START_BIT)

#define AW_HMUTE_DISABLE (0)
#define AW_HMUTE_DISABLE_VALUE (AW_HMUTE_DISABLE << AW_HMUTE_START_BIT)
...
#define AW_BOP_EN_DISABLE_VALUE (AW_BOP_EN_DISABLE << AW_BOP_EN_START_BIT)

#define AW_BOP_EN_ENABLE (1)
#define AW_BOP_EN_ENABLE_VALUE (AW_BOP_EN_ENABLE << AW_BOP_EN_START_BIT)
...
#define AW_I2STXEN_DISABLE_VALUE (AW_I2STXEN_DISABLE << AW_I2STXEN_START_BIT)

#define AW_I2STXEN_ENABLE (1)
#define AW_I2STXEN_ENABLE_VALUE (AW_I2STXEN_ENABLE << AW_I2STXEN_START_BIT)

/* VOL bit 9:0 (SYSCTRL2 0x05) */
#define FADE_DEFAULT_VOL_STEP (64)
#define AW_VOL_START_BIT (0)
#define AW_VOL_BITS_LEN (10)
#define AW_VOL_MASK (~(((1 << AW_VOL_BITS_LEN) - 1) << AW_VOL_START_BIT))

/* CHSEL bit 11:10 (I2SCTRL1 0x06) */
#define AW_CHSEL_START_BIT (10)
#define AW_CHSEL_BITS_LEN (2)
#define AW_CHSEL_MASK (~(((1 << AW_CHSEL_BITS_LEN) - 1) << AW_CHSEL_START_BIT))

#define AW_CHSEL_RESERVED (0)
#define AW_CHSEL_RESERVED_VALUE (AW_CHSEL_RESERVED << AW_CHSEL_START_BIT)

#define AW_CHSEL_LEFT (1)
#define AW_CHSEL_LEFT_VALUE (AW_CHSEL_LEFT << AW_CHSEL_START_BIT)

#define AW_CHSEL_RIGHT (2)
#define AW_CHSEL_RIGHT_VALUE (AW_CHSEL_RIGHT << AW_CHSEL_START_BIT)
...
#define AW_CCO_MUX_DIVIDED_VALUE (AW_CCO_MUX_DIVIDED << AW_CCO_MUX_START_BIT)

#define AW_CCO_MUX_BYPASS (1)
#define AW_CCO_MUX_BYPASS_VALUE (AW_CCO_MUX_BYPASS << AW_CCO_MUX_START_BIT)

#define AW_VOL_DEFAULT (0)
#define AW_VOL_DEFAULT_VALUE (AW_VOL_DEFAULT << AW_VOL_START_BIT)
...
#define AW_NOISE_GATE_EN_MASK                     \
	(~(((1 << AW_NOISE_GATE_EN_BITS_LEN) - 1) \
	   << AW_NOISE_GATE_EN_START_BIT))
...
#define AW_EF_LOCK_ENABLE_VALUE (AW_EF_LOCK_ENABLE << AW_EF_LOCK_STRAT_BIT)
...
#define AW_PID_2116_EN_PA_MASK                     \
	(~(((1 << AW_PID_2116_EN_PA_BITS_LEN) - 1) \
	   << AW_PID_2116_EN_PA_START_BIT))
...
#define AW_PID_2116_ULS_HMUTE_MASK                     \
	(~(((1 << AW_PID_2116_ULS_HMUTE_BITS_LEN) - 1) \
	   << AW_PID_2116_ULS_HMUTE_START_BIT))
...
#define AW_PID_2116_I2STXEN_MASK                     \
	(~(((1 << AW_PID_2116_I2STXEN_BITS_LEN) - 1) \
	   << AW_PID_2116_I2STXEN_START_BIT))
...
#define AW_PID_2116_CCO_MUX_MASK                     \
	(~(((1 << AW_PID_2116_CCO_MUX_BITS_LEN) - 1) \
	   << AW_PID_2116_CCO_MUX_START_BIT))
...
#define AW_PID_2116_BOP_EN_MASK                     \
	(~(((1 << AW_PID_2116_BOP_EN_BITS_LEN) - 1) \
	   << AW_PID_2116_BOP_EN_START_BIT))
...
#define AW_PID_2116_SWS_SYSST_CHECK \
	(AW_SWS_SWITCHING_VALUE | AW_CLKS_STABLE_VALUE | AW_PLLS_LOCKED_VALUE)
...
#define AW_PID_2308_PSM_EN_MASK                     \
	(~(((1 << AW_PID_2308_PSM_EN_BITS_LEN) - 1) \
	   << AW_PID_2308_PSM_EN_START_BIT))
...
#define AW_PID_2308_EN_MPD_MASK                     \
	(~(((1 << AW_PID_2308_EN_MPD_BITS_LEN) - 1) \
	   << AW_PID_2308_EN_MPD_START_BIT))
...
#define AW_PID_2308_DSMZTH_MASK                     \
	(~(((1 << AW_PID_2308_DSMZTH_BITS_LEN) - 1) \
	   << AW_PID_2308_DSMZTH_START_BIT))
