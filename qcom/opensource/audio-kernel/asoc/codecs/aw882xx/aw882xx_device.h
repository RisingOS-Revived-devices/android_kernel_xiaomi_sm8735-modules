...
struct aw_device_ops {
	...
	int (*aw_i2c_write)(struct i2c_client *i2c, unsigned char reg_addr,
			    unsigned int reg_data);
	int (*aw_i2c_read)(struct i2c_client *i2c, unsigned char reg_addr,
			   unsigned int *reg_data);
	int (*aw_i2c_write_bits)(struct i2c_client *i2c, unsigned char reg_addr,
...
void aw882xx_dev_iv_forbidden_output(struct aw_device *aw_dev,
				     bool power_waste);
