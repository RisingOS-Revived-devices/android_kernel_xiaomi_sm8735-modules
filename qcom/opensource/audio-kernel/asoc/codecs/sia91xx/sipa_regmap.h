...
int sipa_write_reg(struct regmap *regmap, unsigned char subaddr,
		   unsigned int val);
int sia91xx_write_reg16_bit_pos(sipa_dev_t *si_pa, uint8_t subaddr,
				uint16_t Val, uint8_t pos, uint8_t len);
int sia91xx_write_reg16_bit_msk(sipa_dev_t *si_pa, uint8_t subaddr,
				uint16_t msk, bool stat);
