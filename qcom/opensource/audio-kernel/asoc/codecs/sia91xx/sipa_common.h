...
#define SIPA_DRIVER_VERSION ("3.1.11-250528")
...
enum {
	...
	CHIP_TYPE_SIA8109, //1
	CHIP_TYPE_SIA8152, //2
	CHIP_TYPE_SIA8152S, //3
	CHIP_TYPE_SIA8159, //4
	CHIP_TYPE_SIA8159A, //5
	...
	CHIP_TYPE_SIA8001, //9
	CHIP_TYPE_SIA8102, //10
	CHIP_TYPE_SIA9177, //11
	CHIP_TYPE_SIA9255, //12
	// new add
	CHIP_TYPE_SIA8100X,
	CHIP_TYPE_SIA81X9,
	CHIP_TYPE_SIA8152X,
	...
	CHIP_TYPE_SIA5118S = 23, //23
	CHIP_TYPE_SIA5118X = 24,
	CHIP_TYPE_SIA9306 = 25, //25
...
#define IS_DIGITAL_PA_TYPE(type)                                     \
	(type == CHIP_TYPE_SIA9195 || type == CHIP_TYPE_SIA9196 ||   \
	 type == CHIP_TYPE_SIA9175 || type == CHIP_TYPE_SIA9255 ||   \
	 type == CHIP_TYPE_SIA9177 || type == CHIP_TYPE_SIA9187 ||   \
	 type == CHIP_TYPE_SIA5118 || type == CHIP_TYPE_SIA5118S ||  \
	 type == CHIP_TYPE_SIA5118X || type == CHIP_TYPE_SIA9197X || \
	 type == CHIP_TYPE_SIA917X || type == CHIP_TYPE_SIA9306) ?   \
		true :                                               \
		false

#define IS_SUPPORT_OWI_TYPE(type)                                  \
	(type == CHIP_TYPE_SIA8001 || type == CHIP_TYPE_SIA8102 || \
...
#define IS_NEED_PULL_RST_TYPE(type)                                  \
	(type == CHIP_TYPE_SIA81X9 || type == CHIP_TYPE_SIA8109 ||   \
	 type == CHIP_TYPE_SIA815T || type == CHIP_TYPE_SIA5118 ||   \
	 type == CHIP_TYPE_SIA5118S || type == CHIP_TYPE_SIA5118X || \
