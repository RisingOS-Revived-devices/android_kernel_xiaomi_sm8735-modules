...
static const struct reg_map_info reg_map_info_table[] = {
	[CHIP_TYPE_SIA8101] = { .chip_type = CHIP_TYPE_SIA8101,
				.reg_addr_width = 8,
				.reg_val_width = 8,
				.chip_id_addr = 0x00,
				.chip_id_ranges = { { 0x80, 0x8f } },
				.chip_id_range_num = 1 },
	[CHIP_TYPE_SIA8109] = { .chip_type = CHIP_TYPE_SIA8109,
				.reg_addr_width = 8,
				.reg_val_width = 8,
				.chip_id_addr = 0x41,
				.chip_id_ranges = { { 0x09, 0x09 },
						    { 0x9B, 0x9B } },
				.chip_id_range_num = 2 },
	[CHIP_TYPE_SIA8152] = { .chip_type = CHIP_TYPE_SIA8152,
				.reg_addr_width = 8,
				.reg_val_width = 8,
				.chip_id_addr = 0x00,
				.chip_id_ranges = { { 0x52, 0x57 } },
				.chip_id_range_num = 1 },
	[CHIP_TYPE_SIA8152S] = { .chip_type = CHIP_TYPE_SIA8152S,
				 .reg_addr_width = 8,
				 .reg_val_width = 8,
				 .chip_id_addr = 0x00,
				 .chip_id_ranges = { { 0x5C, 0x5F } },
				 .chip_id_range_num = 1 },
	[CHIP_TYPE_SIA8159] = { .chip_type = CHIP_TYPE_SIA8159,
				.reg_addr_width = 8,
				.reg_val_width = 8,
				.chip_id_addr = 0x00,
				.chip_id_ranges = { { 0x60, 0x68 } },
				.chip_id_range_num = 1 },
	[CHIP_TYPE_SIA8159A] = { .chip_type = CHIP_TYPE_SIA8159A,
				 .reg_addr_width = 8,
				 .reg_val_width = 8,
				 .chip_id_addr = 0x00,
				 .chip_id_ranges = { { 0x58, 0x58 } },
				 .chip_id_range_num = 1 },
	[CHIP_TYPE_SIA9175] = { .chip_type = CHIP_TYPE_SIA9175,
				.reg_addr_width = 8,
				.reg_val_width = 16,
				.chip_id_addr = 0x07,
				.chip_id_ranges = { { 9175, 9175 } },
				.chip_id_range_num = 1 },
	[CHIP_TYPE_SIA9195] = { .chip_type = CHIP_TYPE_SIA9195,
				.reg_addr_width = 8,
				.reg_val_width = 16,
				.chip_id_addr = 0x06,
				.chip_id_ranges = { { 195 << 7,
						      (195 << 7) | 0x7f } },
				.chip_id_range_num = 1 },
	[CHIP_TYPE_SIA9196] = { .chip_type = CHIP_TYPE_SIA9196,
				.reg_addr_width = 8,
				.reg_val_width = 16,
				.chip_id_addr = 0x06,
				.chip_id_ranges = { { 0x6190, 0x6191 },
						    { 0x6200, 0x6200 } },
				.chip_id_range_num = 2 },
	[CHIP_TYPE_SIA9177] = { .chip_type = CHIP_TYPE_SIA9177,
				.reg_addr_width = 8,
				.reg_val_width = 16,
				.chip_id_addr = 0x06,
				.chip_id_ranges = { { 0x5880, 0x5880 },
						    ...
						    { 0x58A0, 0x58A1 } },
				.chip_id_range_num = 3 },
	[CHIP_TYPE_SIA8150] = { .chip_type = CHIP_TYPE_SIA8150,
				.reg_addr_width = 8,
				.reg_val_width = 8,
				.chip_id_addr = 0x00,
				.chip_id_ranges = { { 0x50, 0x50 } },
				.chip_id_range_num = 1 },
	[CHIP_TYPE_SIA9255] = { .chip_type = CHIP_TYPE_SIA9255,
				.reg_addr_width = 8,
				.reg_val_width = 16,
				.chip_id_addr = 0x06,
				.chip_id_ranges = { { 0x4d80, 0x4d80 } },
				.chip_id_range_num = 1 },
	[CHIP_TYPE_SIA815T] = { .chip_type = CHIP_TYPE_SIA815T,
				.reg_addr_width = 8,
				.reg_val_width = 8,
				.chip_id_addr = 0x00,
				.chip_id_ranges = { { 0x6a, 0x6f } },
				.chip_id_range_num = 1 },
	[CHIP_TYPE_SIA9187] = { .chip_type = CHIP_TYPE_SIA9187,
				.reg_addr_width = 8,
				.reg_val_width = 16,
				.chip_id_addr = 0x06,
				.chip_id_ranges = { { 0x5d80, 0x5d90 } },
				.chip_id_range_num = 1 },
	[CHIP_TYPE_SIA5118] = { .chip_type = CHIP_TYPE_SIA5118,
				.reg_addr_width = 8,
				.reg_val_width = 16,
				.chip_id_addr = 0x00,
				.chip_id_ranges = { { 0x3B00, 0x3B01 } },
				.chip_id_range_num = 1 },
	[CHIP_TYPE_SIA9197X] = { .chip_type = CHIP_TYPE_SIA9197X,
				 .reg_addr_width = 8,
				 .reg_val_width = 16,
				 .chip_id_addr = 0x00,
				 .chip_id_ranges = { { 0x6281, 0x6281 },
						     { 0x6290, 0x6290 },
						     { 0x6310, 0x6310 } },
				 .chip_id_range_num = 3 },
	[CHIP_TYPE_SIA8132] = { .chip_type = CHIP_TYPE_SIA8132,
				.reg_addr_width = 8,
				.reg_val_width = 8,
				.chip_id_addr = 0x00,
				.chip_id_ranges = { { 0x32, 0x32 } },
				.chip_id_range_num = 1 },
	[CHIP_TYPE_SIA5118S] = { .chip_type = CHIP_TYPE_SIA5118S,
				 .reg_addr_width = 8,
				 .reg_val_width = 16,
				 .chip_id_addr = 0x00,
				 .chip_id_ranges = { { 0x3B80, 0x3B82 } },
				 .chip_id_range_num = 1 },
	[CHIP_TYPE_SIA9306] = { .chip_type = CHIP_TYPE_SIA9306,
				.reg_addr_width = 8,
				.reg_val_width = 16,
				.chip_id_addr = 0x00,
				.chip_id_ranges = { { 0x5300, 0x5300 } },
				.chip_id_range_num = 1 },
};
...
retry:
	...
	if (ret < 0) {
		...
		if (retries) {
			retries--;
			usleep_range(I2C_RETRY_DELAY * 1000,
				     I2C_RETRY_DELAY * 1000);
			goto retry;
		}
...
int sipa_regmap_write(struct regmap *regmap, unsigned int chip_type,
		      unsigned int start_reg, unsigned int reg_num,
		      const void *buf)
{
	if (NULL == regmap) {
		pr_warn("[ warn][%s] %s: NULL == regmap \n", LOG_FLAG,
...
static bool sipa_writeable_register(struct device *dev, unsigned int reg)
{
	return true;
}

static bool sipa_readable_register(struct device *dev, unsigned int reg)
{
	return true;
}

static bool sipa_volatile_register(struct device *dev, unsigned int reg)
{
	return true;
}

static int verify_chip_type(unsigned int ch, unsigned int type)
{
...
struct regmap *sipa_regmap_init(struct i2c_client *client, unsigned int ch,
 ...
 ********************************************************************/
int sipa_regmap_check_chip_id(struct regmap *regmap, unsigned int ch,
			      unsigned int chip_type)
{
	int i = 0;
	unsigned int val = 0;
	...
	if (0 != sipa_read_reg(regmap,
			       reg_map_info_table[chip_type].chip_id_addr,
			       &val)) {
	...
	for (i = 0; i < reg_map_info_table[chip_type].chip_id_range_num; i++) {
		if (val >= reg_map_info_table[chip_type]
				    .chip_id_ranges[i]
				    .begin &&
	...
	pr_err("[  err][%s] %s: chip_id_addr(0x%04x), val(0x%04x) out of range\n",
	       LOG_FLAG, __func__, reg_map_info_table[chip_type].chip_id_addr,
	       val);
	return -1;
}
 ...
 */
void sipa_regmap_defaults(struct regmap *regmap, unsigned int chip_type,
			  unsigned int scene, unsigned int channel_num)
{
	int i = 0;
	int ret = -ENOENT;
	...
	if (init_list->node_size != sizeof(SIPA_REG_COMMON)) {
		pr_err("[  err][%s] %s: node_size(%u) != sizeof(SIPA_REG_COMMON)(%lu)",
		       LOG_FLAG, __func__, init_list->node_size,
		       sizeof(SIPA_REG_COMMON));
		return;
	}

	init_regs = (SIPA_REG_COMMON *)(data + init_list->offset);
	for (i = 0; i < init_list->num; i++) {
		ret = sipa_write_reg(regmap, init_regs[i].addr,
				     init_regs[i].val[scene]);
		if (0 != ret) {
...
static int sipa_regmap_proc_1_reg(sipa_dev_t *si_pa, SIPA_REG_PROC *reg,
	...
	case SIPA_REG_READ:
		...
		if (reg->addr <= 0x14)
			pr_info("[ info][%s] %s: addr:0x%x, val:0x%04x\n",
				LOG_FLAG, __func__, reg->addr, val);
		break;
	case SIPA_REG_WRITE:
...
static int sipa_regmap_proc_1_reg_list(sipa_dev_t *si_pa,
				       const SIPA_PARAM_LIST *list,
				       SIPA_REG_PROC *regs, uint32_t val_width)
{
	int i = 0;
	int ret = -ENOENT;
	...
	if (list->node_size != sizeof(SIPA_REG_PROC)) {
		pr_err("[  err][%s] %s: node_size(%u) != sizeof(SIPA_REG_PROC)(%lu)",
		       LOG_FLAG, __func__, list->node_size,
		       sizeof(SIPA_REG_PROC));
		return -ENOEXEC;
	}
	...
	for (i = 0; i < list->num; i++) {
		...
		if (0 != ret) {
			pr_err("[  err][%s] %s: ret = %d, chip_type = %u, regmap = %p, addr = 0x%x\n",
			       LOG_FLAG, __func__, ret, si_pa->chip_type,
			       si_pa->regmap, regs[i].addr);
			return ret;
		}
	}
...
bool sipa_regmap_set_chip_on(sipa_dev_t *si_pa)
{
	...
	data = sipa_param_read_chip_cfg(si_pa->channel_num, si_pa->chip_type,
					&chip_cfg);
	if (NULL == data) {
		pr_err("[  err][%s] %s: fw unloaded \n", LOG_FLAG, __func__);
		return false;
	...
	if (0 != sipa_regmap_proc_1_reg_list(si_pa, startup_list, startup_regs,
...
bool sipa_regmap_set_chip_off(sipa_dev_t *si_pa)
{
	...
	if (0 != sipa_regmap_proc_1_reg_list(si_pa, shutdown_list,
					     shutdown_regs,
					     chip_cfg.reg_val_width))
		return false;
...
bool sipa_regmap_get_chip_en(sipa_dev_t *si_pa)
{
	...
	pr_info("[ info][%s] %s: addr:0x%x val:0x%x mask:%x  fw_val:%x  \n",
		LOG_FLAG, __func__, reg_en->addr, val, reg_en->mask,
		reg_en->val);
	return false;
}

void sipa_regmap_set_pvdd_limit(struct regmap *regmap, uint32_t chip_type,
				uint32_t ch, unsigned int vol)
{
	SIPA_CHIP_CFG chip_cfg;
	uint8_t *data;
	...
	if (0 !=
	    sipa_read_reg(regmap, pvdd_limit->reg.addr, &pvdd_limit->reg.val))
		return;

	pvdd_limit->reg.val =
		(pvdd_limit->reg.val & (~pvdd_limit->reg.mask)) |
		((cp_ovp << pvdd_limit->bit_offset) & pvdd_limit->reg.mask);

	if (0 !=
	    sipa_write_reg(regmap, pvdd_limit->reg.addr, pvdd_limit->reg.val))
		return;
}
				      ...
				      uint8_t *buff, uint32_t buff_len)
{
	...
	if (NULL == si_pa || NULL == list || NULL == regs || NULL == buff ||
	    0 == buff_len)
		return 0;
...
void sipa_regmap_check_trimming(sipa_dev_t *si_pa)
{
	...
	trim_bytes = sipa_regmap_bits_pack(si_pa, reg_list, regs, val_width,
					   trim, sizeof(trim));
	if (0 >= trim_bytes) {
	...
	if (sizeof(crc) * 8 < crc_width) {
		pr_err("[  err][%s] %s: 16 < crc_width(%u)", LOG_FLAG, __func__,
		       crc_width);
		return;
	}
	...
	ret = sipa_regmap_bits_pack(si_pa, reg_list, regs, val_width, crc_buff,
				    sizeof(crc_buff));
	if (crc_width != ret) {
	...
	if (crc_cal != crc) {
		...
		if (si_pa->chip_type == CHIP_TYPE_SIA8159) {
			...
			for (i = 0; i < reg_list->num; i++) {
				...
				ret = sipa_regmap_proc_1_reg(si_pa, &regs[i],
							     val_width);
				if (0 != ret) {
					pr_err("[  err][%s] %s: ret = %d, chip_type = %u, regmap = %p, addr = 0x%x\n",
					       LOG_FLAG, __func__, ret,
					       si_pa->chip_type, si_pa->regmap,
					       regs[i].addr);
					return;
				}
			}
...
bool sipa_regmap_write_sram(sipa_dev_t *si_pa)
{
	...
	for (i = 0; i < sram_list->num; i++) {
		...
		//high word write
		ret = regmap_write(si_pa->regmap, cfg_addr,
				   (sram_data[i].addr | 0x80));
		if (0 != ret) {
			pr_warn("[ warn][%s] %s: ret = %d, chip_type = %u, regmap = %p, addr = 0x%x, value = %d\n",
				LOG_FLAG, __func__, ret, si_pa->chip_type,
				si_pa->regmap, cfg_addr, sram_data[i].addr);
			continue;
		}
