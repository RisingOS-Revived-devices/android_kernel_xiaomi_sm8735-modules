...
#define WMFW_CTL_TYPE_ACKED \
	((__force snd_ctl_elem_type_t)0x1000) /* acked control */
#define WMFW_CTL_TYPE_HOSTEVENT \
	((__force snd_ctl_elem_type_t)0x1001) /* event control */
#define WMFW_CTL_TYPE_HOST_BUFFER \
	((__force snd_ctl_elem_type_t)0x1002) /* host buffer pointer */
