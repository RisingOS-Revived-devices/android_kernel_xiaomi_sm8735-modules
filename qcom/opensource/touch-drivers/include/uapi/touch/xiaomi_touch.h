...
#ifndef _UAPI_TOUCH_XIAOMI_TOUCH_H
#define _UAPI_TOUCH_XIAOMI_TOUCH_H
...
enum common_data_mode {
	...
	Touch_Stylus_Sleep_Status =
		29, /* 8650接收29用+105转发 8750可以直接转发29*/
	Touch_Wakeup_Enable = 30,
	TOUCH_SENSOR_ENABLE = 31,
	Touch_Thp_Gesture_Type = 32,
	Touch_Stylus_Gamemode_Enable = 33,
	TOUCH_POWER_SAVE_MODE = 34,
	Touch_Fod_Setting = 35,
	TOUCH_STYLUS_PAINTAPP_ENABLE = 36,
	Touch_Fod_Longpress_Gesture = 37,
	Touch_Mode_NUM = 38,
	TOUCH_CLOUD_MODE_WATER_PROOF = 100,
	TOUCH_CLOUD_MODE_GLOVE_STATUS = 101,
	TOUCH_CLOUD_MODE_FILM_STATUS = 102,
	TOUCH_CLOUD_MODE_CLOSE_SCP_TP_MISTOUCH = 103,
	TOUCH_CLOUD_MODE_NUM,
	...
	THP_Coor_Ai_Predict = TOUCH_MOTION_BASE + 7,
	THP_Hot_Area_Type = TOUCH_MOTION_BASE + 20, // hot area
	THP_Hot_Area_EN = TOUCH_MOTION_BASE + 21,
	THP_CMD_BASE = 1000,
	...
	Touch_THP_Super_Resolution = THP_CMD_BASE + 81,
	Touch_THP_Dump_Size = THP_CMD_BASE + 82,
	Touch_Disconnect_Detect = THP_CMD_BASE + 83,
	THP_IDLE_THD = THP_CMD_BASE + 84,
	THP_Dynamic_Report_Rate = THP_CMD_BASE + 85,
	THP_Input_Vsync_Time = THP_CMD_BASE + 86,
	THP_BREAK_LINE_DATA_RENAME_EN = THP_CMD_BASE + 87,
	THP_HAL_STYLUS_PRESSURE = THP_CMD_BASE + 88,
	THP_HAL_STYLUS_ACTIVE = THP_CMD_BASE + 89,
	THP_ENABLE_WRITE_THP_TIME = THP_CMD_BASE + 90,
	...
	THP_GLOVE_TEST_MODE = THP_CMD_BASE + 95,
	THP_CALLBACK_PROCESS = THP_CMD_BASE + 96,
	Touch_APP_AREA_INFO = THP_CMD_BASE + 97,
	THP_IC_FREQ_HOPPING = THP_CMD_BASE + 98,
	THP_IC_CALIBRATION = THP_CMD_BASE + 99,
	THP_IC_SOFT_RESET = THP_CMD_BASE + 100,
	THP_IC_DOUBLE_SCAN = THP_CMD_BASE + 101,
	THP_IC_NORMALIZE_STUDY = THP_CMD_BASE + 102,
	THP_IC_GESTRUE_FEEDBACK = THP_CMD_BASE + 103,
	THP_HAL_ATTITUDE_DETECT = THP_CMD_BASE + 104,
	THP_TRACE_LEVEL = THP_CMD_BASE + 105,
	Touch_Proximity_Mode = THP_CMD_BASE + 106,
	Touch_Gesture_Type = THP_CMD_BASE + 107,
	THP_LOOPBACK_MODE = THP_CMD_BASE + 108,
	TOUCH_GAME_FREEFORM_INFO = THP_CMD_BASE + 109,
	THP_AREA_ALG_PARAM_STEP = THP_CMD_BASE + 110,
	THP_HAL_IDLE_RATE = THP_CMD_BASE + 111,
	...
	Touch_GAMETURBOTOOL_MISTOUCH = Touch_GAMETURBOTOOL_BASE + 4,
	Touch_GAMETURBOTOOL_HOTAREA = Touch_GAMETURBOTOOL_BASE + 5,
	Touch_GAMETURBOTOOL_NUM,
	Touch_GAMETURBOTOOL_PACKAGE = Touch_GAMETURBOTOOL_BASE + 100,
	Touch_GAMETURBOTOOL_GAME_START = Touch_GAMETURBOTOOL_BASE + 101,
	Touch_GAMETURBOTOOL_FOLLOWUP_LEVEL = Touch_GAMETURBOTOOL_BASE + 102,
	Touch_GAMETURBOTOOL_CMD_NUM,
};
...
enum THP_IC_MODE_TYPE {
	...
	SET_POS_GESTURE_EN = THP_IC_CMD_BASE + 47,
	SET_IDLE_BASE = THP_IC_CMD_BASE + 48,
	SET_IDLE_SEND_RAW_TIME = THP_IC_CMD_BASE + 49,
	SET_TOUCH_IC_INFO = THP_IC_CMD_BASE + 50,
	SET_MC_RAW_MAX = THP_IC_CMD_BASE + 51,
	SET_SC_RAW_MAX = THP_IC_CMD_BASE + 52,
	SET_PEN_RAW_MAX = THP_IC_CMD_BASE + 53,
	SET_IDLE_HIGH_BASE_EN = THP_IC_CMD_BASE + 54,
	SET_IDLE_HIGH_BASE_T = THP_IC_CMD_BASE + 55,
	SET_IDLE_HIGH_BASE_KEEP_TIME = THP_IC_CMD_BASE + 56,
	SET_IDLE_PERCENTAGE_THD = THP_IC_CMD_BASE + 57,
	SET_STYLUS_GAME_MODE = THP_IC_CMD_BASE + 58,
	SET_STYLUS_PRESSURE = THP_IC_CMD_BASE + 59,
};
...
typedef struct common_data {
	...
	__u16 mode;
	__u16 data_len;
	__s32 data_buf[CMD_DATA_BUF_SIZE];
} common_data_t;

/* ioctl interface (magic 'T'); kernel matches on _IOC_NR(cmd) == enum ioctl_cmd */
#define TOUCH_MAGIC 'T'
#define TOUCH_IOC_COMMON_DATA _IOW(TOUCH_MAGIC, COMMON_DATA_CMD, common_data_t)
#define TOUCH_IOC_SELECT_TOUCH_ID _IOW(TOUCH_MAGIC, SELECT_TOUCH_ID, int)

#endif /* _UAPI_TOUCH_XIAOMI_TOUCH_H */
