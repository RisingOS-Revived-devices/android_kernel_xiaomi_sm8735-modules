...
static const struct nvt_ts_mem_map NT36536_cascade_memory_map = {
	...
	.MMAP_HISTORY_EVENT0_ICS = 0x124E00,
	.MMAP_HISTORY_EVENT1_ICS = 0x124E40,
	/* Phase 2 Host Download */
...
#if TOUCH_THP_SUPPORT
	.XM_HTC_POLL_INFO_ADDR = 0x109F78,
#endif
};
...
//thp start 6.9
	...
	/* FW Flow Debug Message */
	.FW_FLOW_DEBUG_MESSAGE_ADDR = 0x125950,
	/* Phase 2 Host Download */
	.BOOT_RDY_ADDR = 0x1FB50D,
	.ACI_ERR_CLR_ADDR = 0x1FB605,
...
static const struct nvt_ts_trim_id_table trim_id_table[] = {
	...
	{ .id = { 0x15, 0xFF, 0xFF, 0x23, 0x65, 0x03 },
	  .mask = { 1, 0, 0, 1, 1, 1 },
	  .mmap = &NT36536_single_memory_map,
	  .mmap_casc = &NT36536_cascade_memory_map,
	  .hwinfo = &NT36536_hw_info },
	{ .id = { 0x15, 0x0E, 0xFF, 0x23, 0x65, 0x03 },
	  ...
	  .mmap_casc = &NT36536_cascade_memory_map,
	  .hwinfo = &NT36536_hw_info },
	{ .id = { 0x0D, 0xFF, 0xFF, 0x23, 0x65, 0x03 },
	  .mask = { 1, 0, 0, 1, 1, 1 },
	  .mmap = &NT36523D_memory_map,
	  .hwinfo = &NT36523D_hw_info },
	{ .id = { 0x0A, 0xFF, 0xFF, 0x28, 0x65, 0x03 },
	  .mask = { 1, 0, 0, 1, 1, 1 },
	  .mmap = &NT36528A_memory_map,
	  .hwinfo = &NT36528A_hw_info },
	{ .id = { 0x1C, 0xFF, 0xFF, 0x72, 0x66, 0x03 },
	  .mask = { 1, 0, 0, 1, 1, 1 },
	  .mmap = &NT36675_memory_map,
	  .hwinfo = &NT36675_hw_info },
	{ .id = { 0x17, 0xFF, 0xFF, 0x72, 0x66, 0x03 },
	  .mask = { 1, 0, 0, 1, 1, 1 },
	  .mmap = &NT36675_memory_map,
	  .hwinfo = &NT36675_hw_info },
