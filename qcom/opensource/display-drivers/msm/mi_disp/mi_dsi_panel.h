...
#define FPS_COUNT(DDIC_MODE, DDIC_FPS, DDIC_MIN_FPS) \
	((DDIC_MODE * 100000) + (DDIC_FPS * 100) + DDIC_MIN_FPS)
...
enum dbv_Interval { DBV_IN19_27 = 0x0, DBV_IN28_4B, DBV_IN4C_83, DBV_MAX };
...
enum dc_lut_state { DC_LUT_60HZ, DC_LUT_120HZ, DC_LUT_MAX };

enum dc_feature_type { TYPE_NONE = 0, TYPE_CRC_SKIP_BL };
